		...
		<>
			<InspectorControls>
				<PanelBody title={__('Hero Settings', 'global360blocks')}>
					<TextControl
						...
						help={__(
							'If left empty, the block will automatically use the current page title.',
							'global360blocks'
						)}
					/>
					<TextControl
					...
					<MediaUploadCheck>
						<MediaUpload
							...
							render={({ open }) => (
								...
								>
									{background_image
										? __('Change Background Image', 'global360blocks')
										: __('Select Background Image', 'global360blocks')}
								</Button>
							)}
						/>
					</MediaUploadCheck>
			...
			<div {...blockProps}>
				<div className="page-title-hero-editor">
					...
					>
						{background_overlay && background_image && <div className="hero-overlay"></div>}
					...
					{!title && (
						<div className="placeholder-notice">
							<p>
								{__(
									'Enter a title in the sidebar settings to preview your page title hero.',
									'global360blocks'
								)}
							</p>
						</div>
